...
AOSP_MAKEFILE_PATCH_PATH="${BASE_PATH}/patches/core_Makefile-19.1.patch"

AOSP_MAKEFILE_PATCH_URL="https://raw.githubusercontent.com/Wunderment/build_tasks/master/source/core_Makefile-19.1.patch"
